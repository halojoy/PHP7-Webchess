...
if(!empty($_POST['newMessage']))
{
	...
	echo("From $fromPerson To $toPerson<br>");
        ...
        $tmpQuery  = "INSERT INTO " . $CFG_TABLE[communication] . " (gameID,fromID,toID,title,text,postDate,expireDate,ack,commType) ";
        $tmpQuery .= "VALUES ( NULL , $fromPerson , $toPerson, '$msgtitle', '$msgtext', NOW( ) , NULL , '0', '$msgtype' );";
        mysqli_query($dbh, $tmpQuery) or die("can't do query: $tmpQuery");
?>
Message Sent!
